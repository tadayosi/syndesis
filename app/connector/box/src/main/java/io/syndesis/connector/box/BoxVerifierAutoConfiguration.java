...
public class BoxVerifierAutoConfiguration {

    @Bean("box")
    @Scope(ConfigurableBeanFactory.SCOPE_SINGLETON)
    @Lazy
    @ConditionalOnProperty(prefix = "io.syndesis.connector.box.verifier", name = "enabled", matchIfMissing = true)
    public Verifier boxVerifier() {
